...
| 2 | gemini-3.7-flash | 91.7% | 16/18 | 0 | - | 0.0 | 6664 ms | n/a |  |
...
| 2 | gemini-3.7-flash, gemini-flash | 2 | 95.8% | 0 | n/a | 0.0 |
| 3 | gemini-3.7-flash | 1 | 91.7% | 0 | n/a | 0.0 |

- **Best 1-model set:** gemini-flash — 95.8% detection, 0 missed Crit, $0.0158/run.

- **Best 2-model set:** gemini-3.7-flash, gemini-flash — 95.8% detection, 0 missed Crit, n/a/run.
